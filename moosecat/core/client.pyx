...
class Idle:
    ...
    '''
    DATABASE = c.MOOSE_IDLE_DATABASE
    STORED_PLAYLIST = c.MOOSE_IDLE_STORED_PLAYLIST
    QUEUE = c.MOOSE_IDLE_QUEUE
    PLAYLIST = c.MOOSE_IDLE_QUEUE
    PLAYER = c.MOOSE_IDLE_PLAYER
    MIXER = c.MOOSE_IDLE_MIXER
    OUTPUT = c.MOOSE_IDLE_OUTPUT
    OPTIONS = c.MOOSE_IDLE_OPTIONS
    UPDATE = c.MOOSE_IDLE_UPDATE
    STICKER = c.MOOSE_IDLE_STICKER
    SUBSCRIPTION = c.MOOSE_IDLE_SUBSCRIPTION
    MESSAGE = c.MOOSE_IDLE_MESSAGE
    SEEK = c.MOOSE_IDLE_SEEK
